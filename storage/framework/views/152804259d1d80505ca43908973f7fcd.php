...
unset($__errorArgs, $__bag); ?>
    ...
    <form action="<?php echo e(route('login')); ?>" method="POST" autocomplete="off">
        ...
        <div class="form-group">
            ...
            <input type="email" name="correo" id="correo" class="form-control" value="<?php echo e(old('correo')); ?>" placeholder="correo@techsolutions.cl" required autofocus>
        </div>
    ...
    <div style="margin-top: 2rem; text-align: center; border-top: 1px solid rgba(255, 255, 255, 0.05); padding-top: 1.5rem;">
        ...
        <a href="<?php echo e(route('register')); ?>" style="font-size: 0.9rem; color: var(--accent); font-weight: 600; margin-left: 0.25rem; hover: text-decoration: underline;">
            Regístrate aquí
        </a>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pipe_\OneDrive\Desktop\T2-26-(50) - DESARROLLO DE SOFTWARE WEB I\Evaluacion 1\Tech_Solutions\resources\views/auth/login.blade.php ENDPATH**/ ?>